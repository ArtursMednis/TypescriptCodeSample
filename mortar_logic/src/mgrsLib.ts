...
/*
https://github.com/proj4js/mgrs/blob/master/dist/mgrs.js
*/
     ...
     */
    export function inverse(mgrs:string) {
     ...
     */
    function LLtoUTM(ll: { lat: number; lon: number; }) {
      const Lat = ll.lat;
      const Long = ll.lon;
     ...
     */
    function UTMtoLL(utm: { easting?: any; northing?: any; zoneLetter: any; zoneNumber: any; accuracy?: any; }): { lat?: number; lon?: number; top?:number; right?:number; bottom?:number; left?:number }|null { //: { lat: number; lon: number;} | { top:number; right:number; bottom:number; left:number }|null {
    ...
    export function getLetterDesignator(latitude:number): string {
      if (latitude <= 84 && latitude >= 72) {
        ...
        return bandLetters[index] as string;
     ...
     */
    function encode(utm: { northing: any; easting: any; zoneNumber: any; zoneLetter: any; }, accuracy:number) {
     ...
     */
    function get100kID(easting:number, northing:number, zoneNumber:number) {
     ...
     */
    function get100kSetForZone(i:number) {
     ...
     */
    function getLetter100kID(column:number, row:number, parm:number) {
     ...
     */
    function decode(mgrsString:string) {
  ...
  northing meters ${mgrsString}`);
     ...
     */
    function getEastingFromChar(e:string, set:number) {
     ...
     */
    function getNorthingFromChar(n:string, set:number) {
